...
const StartComponent = ({msg}) => {
    ...
    return (
        <Fragment>
             <ModalBody className="StartComponent">{Iconitem}{msg}</ModalBody>
        </Fragment>
    );
}
...
const OkComponent = ({msg}) => {
    ...
    return (
        <Fragment>
             <ModalBody className="OkComponent">{Iconitem}{msg}</ModalBody>
        </Fragment>
    );
}
...
const FailComponent = ({msg}) => {
    ...
    return (
        <Fragment>
             <ModalBody className="FailComponent">{Iconitem}{msg}</ModalBody>
        </Fragment>
    );
}
